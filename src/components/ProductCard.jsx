...
const OurProductsCard = () => (
  <div className="rounded m-3 shadow our-product-card border" style={{ height: '43vh', width: '220px' }}>
    <div
    ...
    >
      <div className="empty d-block" style={{height: '80%'}}></div>
      <div
